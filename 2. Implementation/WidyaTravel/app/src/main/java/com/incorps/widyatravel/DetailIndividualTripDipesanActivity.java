...
public class DetailIndividualTripDipesanActivity extends AppCompatActivity {
    private String URL_DAPAT_PLATNO = "http://widya-travel.000webhostapp.com/api/api_get_platno.php";
    TextView tanggal_jemput, waktu_jemput, lokasi_jemput, kota_awal, kota_tujuan, orang, harga, driver, plat_no;
    private String URL_CANCEL = "http://widya-travel.000webhostapp.com/api/api_cancel_individualtrip.php";

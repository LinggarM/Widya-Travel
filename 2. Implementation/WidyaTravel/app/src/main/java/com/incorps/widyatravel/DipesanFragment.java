...
public class DipesanFragment extends Fragment {
    ...
    private static String URL_DIPESAN_IT = "http://widya-travel.000webhostapp.com/api/api_dapat_individual_trip_dipesan.php";
    private static String URL_DIPESAN_CR = "http://widya-travel.000webhostapp.com/api/api_dapat_car_rent_dipesan.php";

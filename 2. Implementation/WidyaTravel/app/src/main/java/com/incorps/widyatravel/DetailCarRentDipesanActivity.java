...
public class DetailCarRentDipesanActivity extends AppCompatActivity {
    private String URL_DAPAT_PLATNO_CAR_RENT = "http://widya-travel.000webhostapp.com/api/api_get_platno_car_rent.php";
    TextView tanggal_jemput, waktu_jemput, lokasi_jemput, kota, lama, harga, driver, plat_no;
    private String URL_CANCEL = "http://widya-travel.000webhostapp.com/api/api_cancel_carrent.php";

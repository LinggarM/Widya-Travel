...
public class DiprosesFragment extends Fragment {
    ...
    private static String URL_DIPESAN_IT = "http://widya-travel.000webhostapp.com/api/api_dapat_individual_trip_diproses.php";
    private static String URL_DIPESAN_CR = "http://widya-travel.000webhostapp.com/api/api_dapat_car_rent_diproses.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_diproses, null);
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    IndividualTrip individualTrip = new IndividualTrip(kodeTransaksi, namaDriver, kotaPenjemputan, lokasiPenjemputan, kotaTujuan, tanggalPenjemputan, waktuPenjemputan, harga, jumlahOrang, "2");
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    CarRent carRent = new CarRent(kodeTransaksi, namaDriver, kotaPeminjaman, lokasiPeminjaman, tanggalPeminjaman, waktuPeminjaman, lamaPeminjaman, harga, "2", "0");

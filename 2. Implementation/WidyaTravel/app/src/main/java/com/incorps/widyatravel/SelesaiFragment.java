...
public class SelesaiFragment extends Fragment {
    ...
    private static String URL_DIPESAN_IT = "http://widya-travel.000webhostapp.com/api/api_dapat_individual_trip_selesai.php";
    private static String URL_DIPESAN_CR = "http://widya-travel.000webhostapp.com/api/api_dapat_car_rent_selesai.php";
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    IndividualTrip individualTrip = new IndividualTrip(kodeTransaksi, namaDriver, kotaPenjemputan, lokasiPenjemputan, kotaTujuan, tanggalPenjemputan, waktuPenjemputan, harga, jumlahOrang, "3");
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    CarRent carRent = new CarRent(kodeTransaksi, namaDriver, kotaPeminjaman, lokasiPeminjaman, tanggalPeminjaman, waktuPeminjaman, lamaPeminjaman, harga, "3", "0");
